  ...
  return (
    <div className="prompt_card">
      ...
      {session?.user?.id === post.creator._id && pathName === `/profile/${post.creator._id}` && (
        <div className="mt-5 flex items-center gap-4 border-gray-100 border-t pt-3">
          <p
            className="text-sm green_gradient cursor-pointer font-inter"
            onClick={handleEdit}
          >
            Edit
          </p>
          <p
            className="text-sm orange_gradient font-inter cursor-pointer"
